...
import badminton from "@/assets/icons/BadMinton.svg";
  ...
  return (
    <main className="w-full h-full p-5 flex flex-col gap-2 justify-center">
      ...
      <Table className="w-[90%]  p-3 border rounded-md mx-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
        ...
        <TableBody>
          <TableRow key={""}>
            <TableCell className="font-medium">Bad minton</TableCell>
            <TableCell>
              <img src={badminton} className="w-6" alt="" />
            </TableCell>
            <TableCell>12/03/2030</TableCell>
            <TableCell className="text-right">12/02/123</TableCell>
